...
if __name__ == "__main__":
    ...
    parser.add_argument('--multi_gpu', type=bool,
                        default=True, help='nn.Parallel needs or not')
    ...
    parser.add_argument('--load_name_g', type=str,
                        default='', help='load model name')
    # ./models/discriminator_WGAN_epoch2_batchsize4.pth
    parser.add_argument('--load_name_d', type=str,
                        default='', help='load model name')
    # Training parameters
    ...
    parser.add_argument('--lambda_l1', type=float,
                        default=256, help='the parameter of L1Loss')
    parser.add_argument('--lambda_perceptual', type=float, default=100,
    ...
    parser.add_argument('--norm1', type=str, default='none',
                        help='normalization type')
    parser.add_argument('--norm', type=str, default='none',
                        help='normalization type')
    parser.add_argument('--init_type', type=str,
                        default='kaiming', help='the initialization type')
    parser.add_argument('--init_gain', type=float,
                        default=0.2, help='the initialization gain')
    # Dataset parameters
    parser.add_argument('--baseroot', type=str, default='./dataset/data_large',
